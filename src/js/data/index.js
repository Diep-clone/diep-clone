...
export const gunList = {
    "Basic":[
        new Gun([[0.42,0],[0.42,1.88],[-0.42,1.88],[-0.42, 0]],0),
    ],
    "Twin": [
        new Gun([[0.9,0],[0.9,1.88],[0.1,1.88],[0.1, 0]],0),
        new Gun([[-0.1,0],[-0.1,1.88],[-0.9,1.88],[-0.9, 0]],0)
    ],
    "Triplet": [
        new Gun([[0.9,0],[0.9,1.6],[0.1,1.6],[0.1, 0]],0),
        new Gun([[-0.1,0],[-0.1,1.6],[-0.9,1.6],[-0.9, 0]],0),
        new Gun([[0.4,0],[0.4,1.88],[-0.4,1.88],[-0.4, 0]],0)
    ],
    "TripleShot": [
    ...
    "Overload": [
        new Gun([[0.43,0],[0.73,1.4],[-0.73,1.4],[-0.43,0]],0,1),
        new Gun([[0.43,0],[0.73,1.4],[-0.73,1.4],[-0.43,0]],Math.PI/2,1),
        new Gun([[0.43,0],[0.73,1.4],[-0.73,1.4],[-0.43,0]],Math.PI,1),
        new Gun([[0.43,0],[0.73,1.4],[-0.73,1.4],[-0.43,0]],-Math.PI/2,1),
    ],
    "Necromanser":[
        new Gun([[0.43,0],[0.73,1.4],[-0.73,1.4],[-0.43,0]],Math.PI/2,1),
